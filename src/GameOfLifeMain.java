...
public class GameOfLifeMain {
	...
	public static void main(String[] args) {
		...
		ArrayList<Cell> coordList = getGliderList();
	 ...
	 */
	private static ArrayList<Cell> getGliderList() {
		ArrayList<Cell> coordList = new ArrayList<Cell>();
		coordList.add(new Cell(80, 1));
		coordList.add(new Cell(80, 2));
		coordList.add(new Cell(80, 3));
		coordList.add(new Cell(81, 3));
		coordList.add(new Cell(82, 2));
		return coordList;
	}
